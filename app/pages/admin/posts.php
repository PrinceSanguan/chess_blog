...
<div class="col-md-6 mx-auto">
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="form-floating">
      <input value="<?= old_value("title") ?>" type="text" name="title" class="form-control mb-2" id="floatingInput" placeholder="Username">
    ...
    <div class="">
      <textarea rows="4" placeholder="Post Content" id="floatingInput" name="content" type="content" class="form-control"><?= old_value("content") ?></textarea>
    </div>
    ...
    <div class="form-floating">
      <select name="category_id" class="form-select my-3">
...
<div class="col-md-12 mx-auto">
  <form method="post" enctype="multipart/form-data">
    ...
    <h1 class="h3 mb-3 fw-normal" style="text-align: center;">Edit post</h1>
    ...
    <div class="form-floating">
      <input value="<?= old_value("title", $row["title"])?>" type="text" name="title" class="form-control mb-2" id="floatingInput" placeholder="Username">
    ...
    <div class="">
      <textarea id="summernote" rows="4" placeholder="Post Content" id="floatingInput" name="content" type="content" class="form-control"><?= old_value("content", add_root_to_images($row["content"])) ?></textarea>
    </div>
    <?php if (!empty($errors["content"])):?>
      <div class="text-danger"><?=$errors["content"]?></div>
    <?php endif;?>
...
<div class="col-md-6 mx-auto">
  <form method="post">
    ...
    <h1 class="h3 mb-3 fw-normal" style="text-align: center;">Delete post</h1>

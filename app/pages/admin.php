...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <!-- Custom styles for this template -->
    <link href="<?=ROOT?>/assets/css/dasboard.css" rel="stylesheet">
    <link href="<?=ROOT?>/assets/css/dashboard.rtl.css" rel="stylesheet">
  </head>
  <body>
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link <?=$section == "dashboard" ? "active" : "" ?> active" aria-current="page" href="<?=ROOT?>/admin/dashboard">
